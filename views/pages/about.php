            ...
            <div class="col-md-6">
                <div class="d-flex gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-muted">Tất cả sản phẩm đều được nhập từ các nhà phân phối chính thức, có đầy đủ
            ...
            <div class="col-md-6">
                <div class="d-flex gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-muted">Giao hàng toàn quốc trong 1-3 ngày. Miễn phí vận chuyển cho đơn hàng từ
                            500.000đ.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="d-flex gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-muted">Chính sách bảo hành lên đến 36 tháng. Hỗ trợ 1 đổi 1 trong 30 ngày nếu lỗi
                            nhà sản xuất.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="d-flex gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-muted">Đội ngũ tư vấn chuyên nghiệp, sẵn sàng hỗ trợ 24/7 qua hotline, chat và
                            email.</p>
                    </div>
                </div>
            </div>
