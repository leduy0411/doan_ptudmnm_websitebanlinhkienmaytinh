...
class Order
{
    ...
    public function getStatistics($dateFrom = null, $dateTo = null)
    {
        ...
        // Total orders and revenue (only from confirmed/delivered orders, excluding cancelled)
        $sql = "SELECT COUNT(*) as total_orders, 
                COALESCE(SUM(CASE WHEN status IN ('confirmed', 'processing', 'shipping', 'delivered') THEN total ELSE 0 END), 0) as total_revenue 
