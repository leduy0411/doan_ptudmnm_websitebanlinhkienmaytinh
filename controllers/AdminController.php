...
class AdminController
{
    ...
    public function getDashboardStats()
    {
        ...
        // Return flat structure matching dashboard view expectations
        return [
            'total_orders' => $orderStats['total_orders'] ?? 0,
            'order_change' => 0, // TODO: Calculate month-over-month change
            'total_revenue' => $orderStats['total_revenue'] ?? 0,
            'revenue_change' => 0, // TODO: Calculate month-over-month change
            'total_users' => $userStats['total'] ?? 0,
            'user_change' => 0, // TODO: Calculate month-over-month change
